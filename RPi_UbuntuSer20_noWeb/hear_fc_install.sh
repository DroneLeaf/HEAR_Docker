...
catkin_make clean -DTARGET_RPI=$1 -DTARGET_UBUNTU=$2
catkin_make -DCMAKE_BUILD_TYPE=Debug -DTARGET_RPI=$1 -DTARGET_UBUNTU=$2 -Wno-dev
cd
#RUN touch /home/pi/.bashrc

# source HEAR_FC
# source $3/devel/setup.bash
# echo "source $3/devel/setup.bash" >> /home/$4/.bashrc
