...
apt-get install -y --no-install-recommends git wget lcov unzip ca-certificates python 
apt-get install -y python3-pip pkg-config build-essential gperf bison flex libgl1-mesa-dev 
apt-get install -y libglu1-mesa-dev libfontconfig1-dev libdbus-1-dev libfreetype6-dev 
apt-get install -y libicu-dev libinput-dev libxkbcommon-dev libsqlite3-dev libssl-dev 
# apt-get install -y libpng-dev libjpeg-dev libglib2.0-dev libpq-dev libmariadb-dev libmariadbclient-dev 
apt-get install -y libx11-xcb-dev libglu1-mesa-dev libxrender-dev libxi-dev libxkbcommon-dev 
apt-get install -y libxkbcommon-x11-dev libxcb-xfixes0-dev libxcb-xfixes0 libgpiod-dev
